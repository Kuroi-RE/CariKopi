  ...
  return (
    <>
      ...
      <footer className="w-full text-white">
        {/*      <!-- Main footer --> */}
        <div className="border-t border-slate-900 bg-primary pb-12 pt-16 text-sm">
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-colors duration-300 hover:text-secondary focus:text-secondary"
                    >
                      Features
                    </a>
                  </li>
