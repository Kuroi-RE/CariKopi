  ...
  const reviewData = [
    {
      ...
      profesi: "Mahasiswa",
      review:
        "Website ini benar-benar memudahkan saya mencari cafe dengan rating tertinggi di Purwokerto. Saya bisa langsung tahu cafe mana yang sedang trending. Tidak perlu lagi buang waktu mencari-cari, semua informasinya lengkap di sini!",
    },
    {
      nama: "Budi Setiawan",
      profesi: "Mahasiswa",
      review:
        "Sebagai pecinta kopi, saya selalu mencari tempat yang cozy dan punya vibe bagus. Website ini memberikan rekomendasi cafe yang sedang viral dengan cepat. Fitur pencarian dan ratingnya sangat akurat. Love it!",
    },
    {
      nama: "Citra",
      profesi: "Mahasiswa",
      review:
        "Saya dan teman-teman sering bingung mencari tempat nongkrong. Dengan website ini, kami bisa tahu cafe Smana yang paling ramai dikunjungi dan punya ulasan positif. Sempurna untuk yang suka eksplor tempat baru!",
    },
    {
      nama: "Lina",
      profesi: "Freelancer",
      review:
        "Suka bingung cari cafe buat kerja atau sekadar ngobrol santai? Website ini adalah solusi terbaik. Tampilannya simpel, dan informasinya selalu update. Cafe-cafe yang direkomendasikan selalu sesuai ekspektasi.",
    },
  ];
              ...
              return (
                <li key={index}>
                  <div className="h-full w-full">
                    {/*                    <!-- Start Testimonial --> */}
                    <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl">
                      <div className="relative p-6">
                        <figure className="relative z-10">
                          <blockquote className="p-6 text-lg leading-relaxed">
                            <p className="line-clamp-4">{review.review}</p>
                          </blockquote>
                          <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-amber-500">
                            <span
                            ...
                            <div className="flex items-center gap-4 pt-4 text-sm text-amber-500">
                              <img
